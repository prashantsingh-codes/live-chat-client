      ...
      <div style={styles.overlay}>
        <div style={styles.incomingCard}>
          ...
          <div style={{ display: "flex", gap: 40 }}>
            ...
            >
              <button onClick={rejectCall} style={styles.rejectCircle}>
                ✕
              </button>
            ...
            >
              <button onClick={acceptCall} style={styles.acceptCircle}>
                ✓
              </button>
      ...
      {showChat && (
        <div style={styles.chatSheet}>
          ...
          <div style={styles.chatSheetHeader}>
            ...
            <button onClick={() => setShowChat(false)} style={styles.closeBtn}>
              ✕
            </button>
          </div>
